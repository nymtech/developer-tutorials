...
function main() {
  return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var port, localClientUrl, title, sendButton;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            port = '1977'; // client websocket listens on 1977 by default, change if yours is different
            localClientUrl = "ws://127.0.0.1:" + port;
            title = "";
            ...
            _context.next = 7;
            return connectWebsocket(localClientUrl).then(function (c) {
              return c;
            }).catch(function (err) {
          ...
          case 7:
            ...
            sendButton === null || sendButton === void 0 ? void 0 : sendButton.addEventListener('click', function handleClick(event) {
...
function handleReceivedTextMessage(message) {
  ...
  var replySurb = message.replySurb;
  if (replySurb != null) {
...
function displayJsonSend(message) {
  ...
  var paragraphContent = document.createTextNode("sent >>> " + JSON.stringify(message));
...
function displayJsonResponseWithoutReply(message) {
  ...
  var paragraphContent = document.createTextNode("received >>> " + JSON.stringify(message) + "(NO REPLY AVAILABLE)");
  paragraph.appendChild(paragraphContent);
...
function displayJsonResponseWithReply(message, replySurb) {
  ...
  var paragraph = document.createElement("p");
  paragraph.setAttribute('style', 'color: green');
  var paragraphContent = document.createTextNode("received >>> " + JSON.stringify(message) + "(HERE BE SURB)");
  paragraph.appendChild(paragraphContent);
  receivedDiv.appendChild(paragraph);
